pipeline{
  ...
  stages{
    ...
    stage ("Deployment"){
      ...
      sh 'scp -i index.html -o StrictHostKeyChecking=no service.yaml ec2-user@3.109.143.71:/home/ec2-user/'
      sh 'scp -i Capture.PNG -o StrictHostKeyChecking=no service.yaml ec2-user@3.109.143.71:/home/ec2-user/'
